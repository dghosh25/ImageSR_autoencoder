...
x_train_low=Resolution("../DIV2K/DIV2K_train_LR_bicubic/X2/",256)

x_train_high=Resolution("../DIV2K/DIV2K_train_HR/",512)

x_valid_low=Resolution("../DIV2K/DIV2K_valid_LR_bicubic/X2/",256)
...
plt.title("Low Resolution(Bicubic_x2)")
...
autoencoder.save('autoencoder_x2.h5')